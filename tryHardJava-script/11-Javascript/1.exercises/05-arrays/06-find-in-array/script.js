...
(() => {
    ...
    function flamand (stp) {
        return stp.firstname === 'Jean';
    }
    const marche = people.find(flamand)
    const oui = marche.email;
    console.log(marche.email);
    const index = people.findIndex(nvx => nvx === "Jean");
    console.log(index);
})();
